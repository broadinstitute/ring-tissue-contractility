...
def motion_analysis(input_folder, output_folder, pixel_size_um, diameter_um, E, frame_rate):
    """
    Takes in a folder of .mp4 movies,
    processes them, 
    and calculates various metrics (force, stress, strain, contraction and relaxation speed, etc.)
    Saves results a folder as CSV files- 3 files per movie
    """
